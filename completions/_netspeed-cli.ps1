...
Register-ArgumentCompleter -Native -CommandName 'netspeed-cli' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'netspeed-cli' {
            ...
            [CompletionResult]::new('--mini', '--mini', [CompletionResultType]::ParameterName, 'URL of the Speedtest Mini server')
            ...
            [CompletionResult]::new('--share', '--share', [CompletionResultType]::ParameterName, 'Generate and provide a URL to the speedtest.net share results image')
            ...
            [CompletionResult]::new('--secure', '--secure', [CompletionResultType]::ParameterName, 'Use HTTPS instead of HTTP')
            [CompletionResult]::new('--no-pre-allocate', '--no-pre-allocate', [CompletionResultType]::ParameterName, 'Do not pre-allocate upload data')
