...
complete -c netspeed-cli -l no-color -d 'Disable all colors (equivalent to NO_COLOR=1)'
complete -c netspeed-cli -l no-emoji -d 'Replace emoji/icons with plain text (for terminals without emoji support)'
