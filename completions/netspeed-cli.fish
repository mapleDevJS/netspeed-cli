...
complete -c netspeed-cli -l mini -d 'URL of the Speedtest Mini server' -r
...
complete -c netspeed-cli -l share -d 'Generate and provide a URL to the speedtest.net share results image'
complete -c netspeed-cli -l simple -d 'Suppress verbose output, only show basic information'
complete -c netspeed-cli -s v -l verbose -d 'Enable verbose/debug logging'
...
complete -c netspeed-cli -l secure -d 'Use HTTPS instead of HTTP'
complete -c netspeed-cli -l no-pre-allocate -d 'Do not pre-allocate upload data'
