_netspeed-cli() {
    ...
    case "${cmd}" in
        netspeed__cli)
            opts="-h -V --no-download --no-upload --single --bytes --simple --csv --csv-delimiter --csv-header --json --format --list --server --exclude --source --timeout --generate-completion --history --quiet --no-color --no-emoji --dry-run --help --version"
